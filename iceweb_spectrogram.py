...
def main():
	...
	for i in range(np.min([6 n])):
		...
		# PLOT SPECTROGRAM
		axh.append(plt.subplot(n, 1, i*2+2))
		st[i].plot(fig=fh, color='black')) # problem here with attaching to subplot
